...
sh . "$NVM_DIR/nvm.sh" && nvm use v${NODE_VERSION}
sh . "$NVM_DIR/nvm.sh" && nvm alias default v${NODE_VERSION}
...
wget -O $HOME/.supervisord https://raw.githubusercontent.com/DurancOy/duranc_bootstrap/master/gateway/localstr/supervisord.conf
wget -O $HOME/.supervisord https://raw.githubusercontent.com/DurancOy/duranc_bootstrap/master/gateway/localstr/pm2processes.config.js
